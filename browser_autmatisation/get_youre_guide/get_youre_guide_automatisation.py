...
from checks import schreibe_alles, check, get_data_check, go_deeper_check, memgraph_check, check_if_link
...
graph.add_conditional_edges(GET_INFORMATIONS_FAST, is_information_good, {0: NODE_CREATER, 1: GET_INFORMATION_WHOLE_PAGE})
...
asyncio.run(create_data_base("https://www.getyourguide.de/fuerteventura-l419/"))