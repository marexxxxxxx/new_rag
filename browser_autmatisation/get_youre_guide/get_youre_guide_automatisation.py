from llm import json_format, event_checker, formater, get_deep_link, get_informations_fast, get_information_whole_page,is_information_good
...
graph.add_conditional_edges(GET_INFORMATIONS_FAST, is_information_good, {0: GET_DEEP_LINK,1: NODE_CREATER ,2: GET_INFORMATION_WHOLE_PAGE})
graph.add_edge(GET_INFORMATION_WHOLE_PAGE, GET_DEEP_LINK)
